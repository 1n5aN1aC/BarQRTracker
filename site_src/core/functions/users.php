<<<<<<< HEAD:site_src/core/functions/users.php
<?php 
...
function addFood($IDFood,$IDPerson){
	//echo "INSERT INTO `Eaten` (IDFood,IDPerson) VALUES ($IDFood,$IDPerson)";
	$date=date_create(); 
	//echo date_format($date, 'U');
	$date = date_format($date, 'U');
	//$date=date_format($date, 'Y-m-d H:i:s');
	//echo "INSERT INTO `Eaten` (IDFood,IDPerson,dateTime) VALUES ($IDFood,$IDPerson,$date)";
	mysql_query("INSERT INTO `Eaten` (IDFood,IDPerson,dateTime) VALUES ($IDFood,$IDPerson,$date)");	
...
>>>>>>> add food ro person:site src/core/functions/users.php
?>